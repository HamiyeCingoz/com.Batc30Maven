...
public class C01_Maven {
    public static void main(String[] args) {
        ...
        // CLASSIN BASINDA IMPLICITLYWAIT yazilirsa
        // bu test boyunca her locator icin driver maximum yazilan zman kadar bekler
        ...
        WebElement illkUrunElementi=driver.findElement(By.xpath("(//span[@class='a-size-medium a-color-base a-text-normal'])[1]"));
        illkUrunElementi.click();
